...
fetch('MC1/mc1_data/articles/')
    ...
    .then(html => {
        ...
        const filenames = Array.from(doc.querySelectorAll('a'))
            ...
            d3.json("MC1/mc1_data/mc1.json").then(data => {
                ...
                createStackedBarCharts(filenames,docCounts);
    ...
    function createStackedBarCharts(filenames, docCounts) {
        ...
        typeMatrixSvg.append("g")
            ...
            .on("mouseover", function (event, d) {
                const tooltip = d3.select("body").append("div")
                    ...
                    .style("padding", "5px")
                    .style("pointer-events", "none")
                    .html(`Type: ${d.type}<br>Count: ${d.count}<br>Proportion: ${d.proportion}<br>File: ${d.articleId}`);
                tooltip.style("left", (event.pageX + 10) + "px")
                    .style("top", (event.pageY - 10) + "px");
            })
            .on("mousemove", function (event) {
        ...
        editorMatrixSvg.append("g")
            ...
            .on("mouseover", function (event, d) {
                const tooltip = d3.select("body").append("div")
                    ...
                    .style("padding", "5px")
                    .style("pointer-events", "none")
                    .html(`Editor: ${d.editor}<br>Count: ${d.count}<br>Proportion: ${d.proportion}<br>File: ${d.articleId}`);
                tooltip.style("left", (event.pageX + 10) + "px")
                    .style("top", (event.pageY - 10) + "px");
            })
            .on("mousemove", function (event) {
        ...
        algorithmMatrixSvg.append("g")
            ...
            .on("mouseover", function (event, d) {
                const tooltip = d3.select("body").append("div")
                    ...
                    .style("padding", "5px")
                    .style("pointer-events", "none")
                    .html(`Algorithm: ${d.algorithm}<br>Count: ${d.count}<br>Proportion: ${d.proportion}<br>File: ${d.articleId}`);
                tooltip.style("left", (event.pageX + 10) + "px")
                    .style("top", (event.pageY - 10) + "px");
            })
            .on("mousemove", function (event) {
